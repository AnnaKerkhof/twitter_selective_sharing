...
with open('CSV_Sublime\OnlyURL_2018_05_11_Complete_Removals.csv', newline='', encoding='utf-8') as csvfile:
	...
	for row in namesreader:
		...
		if row_counter == 1000:
			...
			with open("CSV_Sublime\LinksUnshortened_2018_05_13_DoubleShorten.csv", "w", newline="", encoding="utf-8") as ergebnisCSV:
