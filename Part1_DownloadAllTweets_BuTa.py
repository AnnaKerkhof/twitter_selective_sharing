...
ergebnisse = []
counter = 0
BuTa_constitution = datetime.strptime("2018-12-27 00:01", "%Y-%m-%d %H:%M")		# angepasst an 199 Tage Zeitraum der ursprünglichen Daten
...
with open("AccountHandles\\NamesBuTANew.csv", newline="", encoding="utf-8") as csvfile:
	...
	for row in namesreader:
		...
		if row[1] != 'None':
			...
			if tempsave == 10:
				...
				with open("Results BuTaNew\\Part 1\\BuTaNew_OnlyURL_2019_07_14.csv", "w", newline="", encoding="utf-8") as ergebnisCSV:
				...
				with open("Results BuTaNew\\Part 1\\BuTaNew_Overview_2019_07_14.csv", "w", newline="", encoding="utf-8") as overviewCSV:
				...
				with open("Results BuTaNew\\Part 1\\BuTaNew_All_Tweets_2019_07_14.csv", "w", newline="", encoding="utf-8") as AllCSV:
				...
				with open("Results BuTaNew\\Part 1\\BuTaNew_Errors_2019_07_14.csv", "w", newline="", encoding="utf-8") as ErrorsCSV:
