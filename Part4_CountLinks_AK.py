# Change-Log:
# - Wenn UnshortenIt Fehler hat (row[9]), greift Skript automatisch auf Spalte mit eigenen Ergebnissen (row[8]) zurÃ¼ck
# - Speicherort verÃ¤ndert
# - ergebnisliste.append Reihenfolge verÃ¤ndert
...
os.chdir("C:\\Users\\wmb815\\Dropbox\\Twitter")



ergebnisse = {'AfD': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}, 'CDU': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}, 'CSU': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}, 'FDP': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}, 'fraktionslos': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}, 'G': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}, 'LINKE': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}, 'SPD': {'bild.de': 0, 'spiegel.de': 0, 'focus.de': 0, 'n-tv.de': 0, 'welt.de': 0, 'zeit.de': 0, 'sueddeutsche.de': 0, 'stern.de': 0, 'faz.net': 0, 'taz.de': 0, 'tagesschau.de': 0, 'zdf.de': 0, 'deutschlandfunk.de': 0}}




with open('OberesDezilWeg.csv', newline='', encoding='utf-8') as csvfile:
	...
	for row in linereader:
		...
		if party == 'fraktionslos':
			...
			if '.zdf.de' in url or url == 'zdf.de':
				ergebnisse['fraktionslos']['zdf.de'] += 1
		...
		if party == 'GRÜNE':
			...
			if '.bild.de' in url or url == 'bild.de':
				ergebnisse['G']['bild.de'] += 1

			if  '.spiegel.de' in url or url == 'spiegel.de':
				ergebnisse['G']['spiegel.de'] += 1

			if '.focus.de' in url or url == 'focus.de':
				ergebnisse['G']['focus.de'] += 1

			if '.n-tv.de' in url or url == 'n-tv.de':
				ergebnisse['G']['n-tv.de'] += 1

			if '.welt.de' in url or url == 'welt.de':
				ergebnisse['G']['welt.de'] += 1

			if '.zeit.de' in url or url == 'zeit.de':
				ergebnisse['G']['zeit.de'] += 1

			if '.sueddeutsche.de' in url or url == 'sueddeutsche.de':
				ergebnisse['G']['sueddeutsche.de'] += 1

			if '.stern.de' in url or url == 'stern.de':
				ergebnisse['G']['stern.de'] += 1

			if '.faz.net' in url or url == 'faz.net':
				ergebnisse['G']['faz.net'] += 1

			if '.taz.de' in url or url == 'taz.de':
				ergebnisse['G']['taz.de'] += 1

			if '.tagesschau.de' in url or url == 'tagesschau.de':
				ergebnisse['G']['tagesschau.de'] += 1

			if '.zdf.de' in url or url == 'zdf.de':
				ergebnisse['G']['zdf.de'] += 1

			if '.deutschlandfunk.de' in url or url == 'deutschlandfunk.de':
				ergebnisse['G']['deutschlandfunk.de'] += 1
...
ergebnisliste = [['Partei', 'bild.de', 'spiegel.de', 'focus.de', 'n-tv.de', 'welt.de', 'zeit.de', 'sueddeutsche.de', 'stern.de', 'faz.net', 'taz.de', 'tagesschau.de', 'zdf.de', 'deutschlandfunk.de']]
...
with open("Ergebnisse_Dezil.csv", "w", newline="", encoding="utf-8") as ergebnisCSV:
