...
with open('Results BuTaNew\Part 1\BuTaNew_OnlyURL_2019_07_14.csv', newline='', encoding='utf-8') as csvfile:
	...
	for row in namesreader:
		...
		if row_counter == 1000:
			...
			with open("Results BuTaNew\Part 2\LinksUnshortened_2020_01_04_BuTa.csv", "w", newline="", encoding="utf-8") as ergebnisCSV:
