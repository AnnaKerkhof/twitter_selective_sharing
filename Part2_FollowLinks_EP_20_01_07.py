...
with open('Results EP\Part 1\EP_OnlyURL_2019_07_15.csv', newline='', encoding='utf-8') as csvfile:
	...
	for row in namesreader:
		...
		if row_counter == 1000:
			...
			with open("Results EP\Part 2\LinksUnshortened_2020_01_04_EP_P1.csv", "w", newline="", encoding="utf-8") as ergebnisCSV:
